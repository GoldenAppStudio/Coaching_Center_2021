...
class InterestVideoRecycle extends RecyclerView.Adapter<InterestVideoRecycle.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        StorageReference gsReference = storage.getReferenceFromUrl("gs://the-question-hub-24bc0.appspot.com//store/videos/" + interestingVideo.getVideo_id() + ".mp4");
...
class MoreVideoRecycler extends RecyclerView.Adapter<MoreVideoRecycler.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference gsReference = storage.getReferenceFromUrl("gs://the-question-hub-24bc0.appspot.com//store/videos/" + moreVideo.getVideo_id() + ".mp4");
