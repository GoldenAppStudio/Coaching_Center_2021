...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = view.findViewById(R.id.notification_fab);
...
class TrendingVideoRecycle extends RecyclerView.Adapter<TrendingVideoRecycle.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        StorageReference gsReference = storage.getReferenceFromUrl("gs://the-question-hub-24bc0.appspot.com//store/videos/" + trendingVideo.getVideo_id() + ".mp4");
